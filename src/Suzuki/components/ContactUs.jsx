                        ...
                        <div className="col-lg-7">
                            <div className="enquiry__form bg-white">
                                <Slider className="car__model__slider" {...settings}>
                                    {data1.map((d, i) => (d?.type === '2' && d?.pages === '8') ? (
                        ...
                        <div className="col-lg-5">
                            <div className="enquiry__form bg-white">
                                <div className="page__title mb-3" style={{ textAlign: "center" }}>
                                    <h2 className="h6 text-uppercase text-black mb-0" style={{ borderBottom: "2px solid #000000" }}>Contact us</h2>
                                </div>
                                <ContactUsForm />
