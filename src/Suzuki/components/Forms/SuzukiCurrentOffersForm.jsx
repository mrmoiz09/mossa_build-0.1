...
const navigate = useNavigate();
      ...
      const onSubmit = async (data) => {
        ...
        setLoading(true);
        await callApi(HomeApi.suzukicurrentOffers.method,HomeApi.suzukicurrentOffers.url,null,finalData,defaultHeader())
        .then((res)=>{
          if(!res?.data?.error)
          {
            setLoading(false);
            ...
            navigate(`/${SuzukiRoutes.thankyou}/suzuki-currentoffers`);
          }
          else
          {
            setLoading(false);
...
export default SuzukiCurrentOffersForm