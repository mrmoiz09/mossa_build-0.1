  ...
  return (
        <section class="moosa_connect--block py-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="page__title dark-line mb-5"  style={{paddingTop:"205px"}}>
                    ...
                    <div class="col-md-8">
                        <div class="moosa_connect__content">
                            ...
                            <h4>Click here to read through the <a href={`${urls.dir_url}/${data}`} target="_blank">Terms and Conditions</a></h4>
                        </div>
                    </div>
                    <div class="col-md-4">
