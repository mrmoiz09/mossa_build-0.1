...
const navigate = useNavigate();
      ...
      const onSubmit = async (data) => {
        console.log(data);
        setLoading(true);
        await callApi(HomeApi.suzukicurrentOffers.method,HomeApi.suzukicurrentOffers.url,null,data,defaultHeader())
        .then((res)=>{
          if(!res?.data?.error)
          {
            setLoading(false);
            ...
            navigate(`/${HomeRoutes.thankyou}/suzuki-currentoffers`);
          }
          else
          {
            setLoading(false);
