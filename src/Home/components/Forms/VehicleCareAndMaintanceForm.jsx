...
const navigate = useNavigate();
    ...
    const { handleSubmit, register, formState: { errors } ,reset} = useForm({
      ...
      const onSubmit = async (data) => {
        ...
        setLoading(true);
        await callApi(HomeApi.vehicle_care_and_maintance_product.method,HomeApi.vehicle_care_and_maintance_product.url,null,finalData,defaultHeader())
        .then((res)=>{
          if(!res?.data?.error)
          {
            setLoading(false);
            ...
            navigate(`/${HomeRoutes.thankyou}/vehicle-care-maintenance-products`);
          }
          else
          {
            setLoading(false);
