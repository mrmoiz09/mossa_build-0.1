...
const navigate = useNavigate();
    ...
    const { handleSubmit, register, formState: { errors } ,reset,getValues} = useForm({
      ...
      const onSubmit = async (data) => {
        ...
        setLoading(true);
        await callApi(HomeApi.multifranchise.method,HomeApi.multifranchise.url,null,finalData,defaultHeader())
        .then((res)=>{
          if(!res?.data?.error)
          {
            setLoading(false);
            ...
            navigate(`/${HomeRoutes.thankyou}/multifranchise`);
          }
          else
          {
            setLoading(false);
...
export default MultiFranchiseForm