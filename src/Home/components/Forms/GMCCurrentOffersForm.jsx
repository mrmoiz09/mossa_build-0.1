...
const navigate = useNavigate();
      ...
      const onSubmit = async (data) => {
        ...
        setLoading(true);
        await callApi(HomeApi.gmccurrentOffers.method,HomeApi.gmccurrentOffers.url,null,finalData,defaultHeader())
        .then((res)=>{
          if(!res?.data?.error)
          {
            setLoading(false);
            ...
            navigate(`/${HomeRoutes.thankyou}/gmc-currentoffers`);
          }
          else
          {
            setLoading(false);
...
export default GMCCurrentOffersForm