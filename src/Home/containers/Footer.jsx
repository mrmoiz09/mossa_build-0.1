                    ...
                    <div className="col-lg-3 col-md-3 col-sm-6">
                     ...
                     <div className="col-lg-3 col-md-3 col-sm-6">
                        <div className="footer-widget">
                            ...
                            <ul className="mb-0 list-unstyled">
                                <li><Link to={`/${HomeRoutes.test_drive}`}>REQUEST A TEST DRIVE</Link></li>
                                <li><Link to={`/${HomeRoutes.requestQuoteRoute}`}>REQUEST A QUOTE</Link></li>
                                <li><Link to={`/${HomeRoutes.ournetworkRoute}`}>OUR NETWORK</Link></li>
                            </ul>
                        </div>
                    </div> 
                   {/* <div className="col-lg-3 col-md-3 col-sm-6">
                    ...
                    <div className="col-lg-3 col-md-3 col-sm-6">
                        <div className="footer-widget">
                            ...
                            <li className="text-uppercase text-white">MARH</li>
                                ...
                                <img className="in-svg" src={Linkedin} width="15" height="15" alt="Linkedin"/>
                                </a>
                                </li>
                            </ul>
                            <ul className="social-icons list-unstyled d-flex align-content-center justify-content-end">
                                ...
                                <li>
                                    <a href="https://www.facebook.com/gmc.oman" target="_blank"><img className="in-svg" width="15" height="15" src={Facebook} alt="Facebook"/></a>
                                </li>
                                <li>
                                    <a href="https://www.instagram.com/gmc_oman/" target="_blank"><img className="in-svg" width="15" height="15" src={Instagram}  alt="Instagram"/></a>
                                </li>
                            ...
                            <ul className="social-icons list-unstyled d-flex align-content-center justify-content-end">
                                ...
                                <li>
                                    <a href="https://www.facebook.com/suzuki.oman/" target="_blank"><img className="in-svg" width="15" height="15" src={Facebook}  alt="Facebook"/></a>
                                </li>
                                <li>
                                    <a href="https://www.instagram.com/suzukioman/" target="_blank"><img className="in-svg" width="15" height="15" src={Instagram}   alt="Instagram"/></a>
                                </li>
                            ...
                            <ul className="social-icons list-unstyled d-flex align-content-center justify-content-end">
                                ...
                                <li>
                                    <a href="https://www.facebook.com/sixt/?brand_redir=640390739632289" target="_blank"><img className="in-svg" width="15" height="15"
                                    src={Facebook}
                                    /></a>
                                </li>
                                <li>
                                    <a href="https://www.instagram.com/sixt_oman/" target="_blank"><img className="in-svg" width="15" height="15" src={Instagram}  alt="Instagram"/></a>
                                </li>
                    ...
                    <div className="col-md-12">
                        <div className="footer__logo text-center mt-5">
                            <Link to={`/`} title="Moosa Abdul Rahman Hassan & Company">
                                <img className="lazy-load"  src={logo} width="645" height="68" alt="Moosa Abdul Rahman Hassan & Company"/>
                            </Link>
                        </div>
                    </div>
                </div>
