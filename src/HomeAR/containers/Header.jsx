                                        ...
                                        <div className="col-md-8">
                                            <div className="header__top--links d-flex align-content-center justify-content-end">
                                                <ul className="header__top--logos list-unstyled mb-0 d-flex align-content-center">
                                                    ...
                                                    <li>
                                                        <a href={`/${SuzukiARRoutes.home}`} target="_blank"><img src={`${urls.frontendUrl}/images/suzuki-logo-white.png`} width="26" height="32" alt="Suzuki"/></a>
                                                    </li>
                                                    <li>
                                                        <a href="https://www.sixt.global/php/reservation/home?language=en_GB&posl=OM&land=OM&fir=412" target="_blank"><img src={`${urls.frontendUrl}/images/SIX2-logo-white.png`} width="48" height="48" alt="SIX2"/></a>
                                                    </li>
                                                </ul>
                                ...
                                <nav className="navbar navbar-expand-lg p-0">
                                    <ul className="navbar-nav">
                                        ...
                                        <li className="nav-item">
                                            ...
                                            <ul className="nav-sub-menu list-unstyled">
                                                <li className="sub-menu-item">
                                                    <Link to={`/${HomeARRoutes.gmccurrentoffers}`}>Gmc Current Offers</Link>
                                                </li>
                                                <li className="sub-menu-item">
                                                    <Link to={`/${HomeARRoutes.suzukicurrentoffers}`}>Suzuki Current Offers</Link>
                                                </li>
                                                <li className="sub-menu-item">
