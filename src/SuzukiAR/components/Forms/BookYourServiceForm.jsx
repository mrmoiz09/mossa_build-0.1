...
const BookYourServiceForm = () => {
  ...
  const onSubmit = async (data) => {
    console.log(data);
    setLoading(true);
    await callApi(HomeApi.book_your_service.method,HomeApi.book_your_service.url,null,data,defaultHeader())
    .then((res)=>{
      if(!res?.data?.error)
      {
        setLoading(false);
    ...
    {!loading ? 
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="row">
          <div className="col">
              <div className="form-group">
              <label htmlFor="vehicle_identification_number">Vehicle Identification Number<span class="text-danger"> *</span></label>
              <input 
                  type="text" 
        ...
        <div className="row">
           <div className="col">
               <div className="form-group">
               <label htmlFor="vehicle_registration">Vehicle Registration<span class="text-danger"> *</span></label>
               <input 
                  type="text" 
