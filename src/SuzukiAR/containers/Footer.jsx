                ...
                <div className="row">
                    <div className="col-lg-3 col-md-3 col-sm-6">
                        <div className="footer-widget">
                            <h4 className="text-white text-uppercase">What's New</h4>
                            <ul className="mb-0 list-unstyled">
                                <li><Link to={`/${SuzukiARRoutes.moosaconnect}`}>MOOSA CONNECT</Link></li>
                    ...
                    <div className="col-lg-3 col-md-3 col-sm-6">
                        <div className="footer-widget">
                            <h4 className="text-white text-uppercase">CONTACT US</h4>
                            <ul className="mb-0 list-unstyled">
                                <li><Link to={`/${SuzukiARRoutes.test_drive}`}>REQUEST A TEST DRIVE</Link></li>
                                <li><Link to={`/${SuzukiARRoutes.requestQuoteRoute}`}>REQUEST A QUOTE</Link></li>
